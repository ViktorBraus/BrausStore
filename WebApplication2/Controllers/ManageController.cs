    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.SetTwoFactorSuccess ? "Двофакторна перевірка справжності налаштована."
                : message == ManageMessageId.Error ? "Сталася помилка."
                : message == ManageMessageId.AddPhoneSuccess ? "Ваш номер телефону доданий."
        ...
        {
            ViewBag.StatusMessage =
                message == ManageMessageId.RemoveLoginSuccess ? "Зовнішнє ім'я для авторизації видалено."
                : message == ManageMessageId.Error ? "Сталася помилка."
                : "";
            var user = await UserManager.FindByIdAsync(User.Identity.GetUserId());
            if (user == null)
